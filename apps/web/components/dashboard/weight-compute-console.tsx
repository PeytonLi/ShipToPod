  ...
  return (
    ...
    >
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          <h2
            id="weight-compute-console-title"
      ...
      <div className="grid gap-3 sm:grid-cols-3 xl:grid-cols-1 2xl:grid-cols-3">
        <Metric
          label="Instance"
          value={snapshot.training.instance ?? "standby"}
        />
        <Metric
          label="Cost"
          value={formatMicrocents(snapshot.training.cost_microcents)}
        />
        <Metric
          label="Loss"
          value={lossValue === null ? "--" : lossValue.toFixed(3)}
        />
      </div>
